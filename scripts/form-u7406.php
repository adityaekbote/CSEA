...
function emailFormSubmission()
{
	...
	$to = '';
	$subject = 'CSE Association | SRM University Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>NAME:</b></td><td>' . htmlentities($_REQUEST["custom_U7416"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>MESSAGE:</b></td><td>' . htmlentities($_REQUEST["custom_U7408"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Register No:</b></td><td>' . htmlentities($_REQUEST["custom_U7423"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From: ' . PHP_EOL . 'Reply-To: ' . $formEmail . PHP_EOL .'X-Mailer: Adobe Muse 2014.0.328 with PHP/' . phpversion() .'/'. PHP_OS . PHP_EOL . 'Content-type: text/html; charset=utf-8' . PHP_EOL;
